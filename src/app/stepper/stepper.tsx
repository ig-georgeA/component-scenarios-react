    ...
    <>
      <div className={classes("column-layout stepper-container")}>
        ...
        <div className={classes("row-layout group_1")}>
          <IgrButton variant="outlined" type="button" onClick={() => stepper?.current?.prev()} className={classes("button_1")}>
          ...
          <IgrButton variant="outlined" type="button" onClick={() => stepper?.current?.next()} className={classes("button_1")}>
