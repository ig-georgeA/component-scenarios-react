    ...
    <>
      <div className={classes("column-layout main-navigation-container")}>
        <IgrNavbar className={classes("navbar")}>
          <div style={{display: 'contents'}} slot="start" onClick={() => navDrawer?.current?.toggle()} key={uuid()}>
            <IgrIconButton>
        ...
        <div className={classes("row-layout group_1")}>
          <IgrNavDrawer position="relative" ref={navDrawer} className={classes("nav-drawer")}>
            ...
            <div style={{display: 'contents'}} onClick={() => navigate(`/forms-grid-crud`)} key={uuid()}>
              <IgrNavDrawerItem>
                ...
                <div slot="content" key={uuid()}>Forms + Grid CRUD</div>
              </IgrNavDrawerItem>
            </div>
